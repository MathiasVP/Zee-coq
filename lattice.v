Require Import Setoid Coq.Classes.Morphisms Basics List PeanoNat Coq.Logic.FinFun Coq.omega.Omega Psatz Coq.Sorting.Mergesort Coq.Structures.Orders Coq.Logic.FinFun Coq.Program.Equality Zee.dec.
...
Infix "⊑" := flowsto (at level 70, no associativity).
...
Section WordLattice.
  ...
  Global Instance word_lattice `{lattice A} : lattice Word.
  Proof.
    econstructor.
    - eapply eq_words_eq.
